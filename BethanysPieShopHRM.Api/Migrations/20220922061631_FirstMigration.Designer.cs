...
namespace BethanyPieShopHRM.Api.Migrations
{
    ...
    [Migration("20220922061631_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanyPieShopHRM.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("BethanyPieShopHRM.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("BethanyPieShopHRM.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BethanyPieShopHRM.Shared.Employee", b =>
                {
                    b.HasOne("BethanyPieShopHRM.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanyPieShopHRM.Shared.JobCategory", "JobCategory")
                        .WithMany()
